...
if(isset($_POST['submit'])){
   ...
   $address = $_POST['zone'] .', '.$_POST['barangay'].', '.$_POST['municipality'].', '.$_POST['province'] .', '. $_POST['zip_code'];
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>your address</h3>
      <input type="text" class="box" placeholder="Zone no." required maxlength="50" name="zone">
